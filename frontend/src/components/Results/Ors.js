    ...
    if(this.props.didRun){
      return (
        <div style={{backgroundColor: "#2b2d3e"}}>
            <h1 style={{color: "aliceblue", fontSize: "2.5rem", fontFamily: "Bungee, cursive", padding: "2rem", background: "black"}}> ONE ROUND SYSTEM </h1>
            <div style={{padding:"4rem", display:"flex", justifyContent: "center", flexDirection: "column"}}> 
              <div style={{display:"flex", justifyContent: "space-evenly"}}> 
                ...
                <div style={{margin: "auto", paddingTop: "5rem", backgroundColor: "#2B2D3E", display: "flex", justifyContent: "center", alignItems: "center"}}>
